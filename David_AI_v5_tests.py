...
v5.alpha_beta(
    difficultPosition, 3, v5.board_score(difficultPosition), True, -99999, 99999
)
v5.alpha_beta(
    promotionPosition, 3, v5.board_score(promotionPosition), True, -99999, 99999
)
...
def performance_test():
    ...
    for depth in range(2, 7):
        ...
        best_move, _ = v5.search(
            _possible_moves,
            depth,
            v5.board_score(difficultPosition),
            True,
            -99999,
            99999,
        )
        ...
        print(
            "\n".join(
                " ".join(piece for piece in row) for row in best_move.__reversed__()
            )
            + "\n"
        )
